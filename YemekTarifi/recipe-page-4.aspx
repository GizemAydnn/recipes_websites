<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="recipe-page-4.aspx.cs" Inherits="YemekTarifi.recipe_page_4" %>
	...
	<div class="alignment">
		...
		<section class="recipe-header">
			<div class="title-alignment">
				<h2>Avokadolu Kavun Salatası</h2>
				<div class="rating five-stars">
					<div class="star-rating"></div>
					<div class="star-bg"></div>
				</div>
				<span><a href="#reviews">(13 görüntüleme)</a></span>
			</div>
		</section>
		...
		<section class="recipe-details" itemprop="nutrition">
			<ul>
				...
				<li>Hazırlık: <strong itemprop="prepTime">10 dk</strong></li>
				<li>Pişme Süresi: <strong itemprop="cookTime">30 Dk</strong></li>
				<li>Kalori: <strong itemprop="calories">135 kcal</strong></li>
			</ul>
		...
		<!-- Text -->
		<p itemprop="description">İşte avokadolu kavun salatası tarifi! Umarım beğenirsiniz. Afiyet olsun!</p>
		...
		<ul class="ingredients">
			<li>
				...
				<label itemprop="ingredients" for="check-1">1 adet olgun avokado</label>
			</li>

			<li>
				<input id="check-2" type="checkbox" name="check" value="check-2">
				<label itemprop="ingredients" for="check-2">1 adet orta boy kavun</label>
			</li>

			<li>
				<input id="check-3" type="checkbox" name="check" value="check-3">
				<label itemprop="ingredients" for="check-3">1/2 demet taze nane</label>
			</li>

			<li>
				<input id="check-4" type="checkbox" name="check" value="check-4">
				<label itemprop="ingredients" for="check-4">1/2 demet taze kişniş</label>
			</li>

			<li>
				<input id="check-5" type="checkbox" name="check" value="check-5">
				<label itemprop="ingredients" for="check-5">1 limonun suyu</label>
			</li>

			<li>
				<input id="check-6" type="checkbox" name="check" value="check-6">
				<label itemprop="ingredients" for="check-6">2 yemek kaşığı zeytinyağı</label>
			</li>	

			<li>
				<input id="check-7" type="checkbox" name="check" value="check-7">
				<label itemprop="ingredients" for="check-7">Tuz ve karabiber (isteğe bağlı)</label>
			</li>											
		</ul>
		...
		<ol class="directions" itemprop="recipeInstructions">
			<li >Avokadonun kabuğunu soyun, çekirdeğini çıkarın ve küçük küpler halinde doğrayın.</li>
			<li>Kavunu yıkayın, kabuğunu soyun ve çekiriklerini temizleyin. Ardından kavunu avokadoyla aynı boyutlarda küp şeklinde doğrayın.</li>
			<li>Taze nane ve kişnişi yıkayın, saplarını ayıklayın ve yapraklarını ince ince doğrayın.</li>
			<li>Büyük bir salata kabında avokado, kavun, nane ve kişnişi bir araya getirin. Hafifçe karıştırın.</li>
			<li>Limon suyu ve zeytinyağını salatanın üzerine gezdirin. Tuz ve karabiber ekleyerek tatlandırma yapabilirsiniz. Dilerseniz baharat çeşitlerini de kullanabilirsiniz.</li>
			<li>Salatayı karıştırarak tüm malzemelerin iyice birbirine karışmasını sağlayın.</li>
			<li>Salatayı buzdolabında en az yarım saat dinlendirin. Böylece malzemelerin lezzetleri birbirine geçecektir.</li>
			<li>Soğutulmuş olarak servis yapın ve afiyetle tüketin.</li>
		</ol>
				...
				<ul>
					<li>
						...
						<div class="comment-content"><div class="arrow-comment"></div>
							...
							<p>Bu salata gerçekten bir harika! Tarifi denemek isteyenlere kesinlikle tavsiye ederim. Kendi damak zevkime uygun bir tarif olduğunu söyleyebilirim. Deneyen herkese afiyet olsun!</p>
							<div class="rating five-stars">
								<div class="star-rating"></div>
								<div class="star-bg"></div>
							</div>
